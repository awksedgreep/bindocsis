...
Enum.each(service_flow_fixtures, fn fixture ->
...
IO.puts("\n" <> String.duplicate("=", 50))
if found_problematic do
  IO.puts("Found the problematic fixture!")
else
  IO.puts("No exact TLV 0, 9, 24 combination found. Need to check other fixtures.")
end
