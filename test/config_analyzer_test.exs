defmodule Bindocsis.ConfigAnalyzerTest do
  ...
  describe "analyze/2" do
    ...
    test "includes optimization suggestions by default" do
      ...
      qos_suggestion =
        Enum.find(analysis.optimization_suggestions, fn suggestion ->
  ...
  describe "compliance checking" do
    ...
    test "can be disabled" do
      assert {:ok, analysis} =
               ConfigAnalyzer.analyze(@residential_config, check_compliance: false)
  ...
  describe "security assessment" do
    ...
    test "can be disabled" do
      assert {:ok, analysis} =
               ConfigAnalyzer.analyze(@residential_config, include_security_check: false)
  ...
  describe "optimization suggestions" do
    test "suggests QoS for configurations without service flows" do
      ...
      qos_suggestion =
        Enum.find(analysis.optimization_suggestions, fn suggestion ->
          String.contains?(suggestion, "Quality of Service") or
            String.contains?(suggestion, "QoS")
        end)
    ...
    test "can be disabled" do
      assert {:ok, analysis} =
               ConfigAnalyzer.analyze(@residential_config, suggest_optimizations: false)
  ...
  describe "TLV analysis" do
    ...
    test "can be disabled" do
      assert {:ok, analysis} =
               ConfigAnalyzer.analyze(@residential_config, include_tlv_details: false)
