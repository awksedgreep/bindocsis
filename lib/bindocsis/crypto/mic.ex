defmodule Bindocsis.Crypto.MIC do
  ...
  defp build_preimage(tlvs, opts) do
    ...
    filtered_tlvs = if strip_mics do
    ...
    binary = Enum.map_join(filtered_tlvs, fn tlv ->
  ...
  @spec find_tlv_value(tlv_list(), non_neg_integer()) :: {:ok, binary()} | {:error, {:missing, String.t()}}
  ...
  @spec validate_mic_length(binary(), non_neg_integer()) :: :ok | {:error, {:invalid_length, map()}}
