defmodule Bindocsis.Accounts do
  @moduledoc """
  ...
  See `Bindocsis.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Bindocsis.Accounts.User.password_changeset/3` for a list of supported options.
